 ...
 */
ZoraPotential::ZoraPotential(const Nuclei &nucs, double zora_factor, double proj_prec, double smooth_prec, bool mpi_share)
...
void ZoraPotential::computeKappa(double prec) {
    ...
    auto kappamap = [zf](double val) { return zf / (zf - val); };
